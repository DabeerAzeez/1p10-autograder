...
def build_grades_csv_for_brightspace(autograder):
    ...
    Inputs
    -------
    results_df: Dataframe of student grades generated by an Autograder, contains the following columns:
                Username|Name|Last Name|First Name|Grade|Out of|Comments.
    autograder: The autograder used to create the results_df dataframe
    """
