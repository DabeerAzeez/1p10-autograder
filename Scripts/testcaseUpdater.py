...
import utils
from Classes.TestCaseWorkbook import TestCaseWorkBook
...
def main():
    ...
    for test_case_sheet in selected_test_case_sheets:
        utils.disable_print()
        test_case_sheet.perform_tests()
        utils.enable_print()
        print("Test sheet " + str(test_case_sheet.name) + " updated!")
